...
func get_csv() -> FileAccess:
	return FileAccess.open("res://tests/handling-model/data/wheel_planar_vector.csv", FileAccess.READ)
...
func body(data: Dictionary):
	...
	match self.wheel_type(data):
		0: wheel_data["type"] = CarTypes.Wheel.FRONT_LEFT
		1: wheel_data["type"] = CarTypes.Wheel.FRONT_RIGHT
		2: wheel_data["type"] = CarTypes.Wheel.REAR_LEFT
		3: wheel_data["type"] = CarTypes.Wheel.REAR_RIGHT
		_: assert(false)
