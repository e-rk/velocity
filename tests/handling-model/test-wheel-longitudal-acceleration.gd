...
func get_csv() -> FileAccess:
	return FileAccess.open("res://tests/handling-model/data/wheel_longitudal_acceleration.csv", FileAccess.READ)
...
func body(data: Dictionary):
	...
	var expected = self.wheel_acceleration(data).z
